   ...
   <div id="kt_app_content_container" class="app-container container-xxl">
      <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
         <div class="card">
            <div class="card-body">
               <!--begin:Form-->
               <form action="{{route('department.update',$department->id)}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_settings_general_form" class="form">
                  @csrf
                  <!--begin::Heading-->
                  ...
                  <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        <label class="fs-6 fw-semibold form-label mt-3">
                           ...
                           <!--end::Label-->
                           <!--begin::Input-->
                           <input type="text" class="form-control form-control-solid" name="department" value="{{$department->department}}"/>
                           <!--end::Input-->
                  </div>
                     <!--end::Col-->
                <!--begin::Col-->
