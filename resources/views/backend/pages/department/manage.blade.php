      ...
      <div class="row g-5 g-xl-10">
         <div class="card">
            ...
            <div class="card-header">
               <h2 class="card-title fw-bold">Department</h2>
               <div class="card-toolbar">
                  <a class="btn btn-primary btn-sm flex-shrink-0 me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_target">Add New Department</a>
               </div>
            </div>
         </div>
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
               ...
               <div class="modal-content rounded">
                  ...
                  <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                     <!--begin:Form-->
                     <form action="{{route('department.store')}}" method="POST" enctype="multipart/form-data" class="form">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                           <!--begin::Title-->
                           <h1 class="mb-3">Add New Department</h1>
                           <!--end::Description-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Input group-->
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                           ...
                           <!--begin::Input-->
                           <input type="text" class="form-control form-control-solid" name="department" value="{{old('department')}}"/>
                           <!--end::Input-->
                        </div>
                        <!--begin::Actions-->
                        ...
                        <tr>
                           ...
                           <td>
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
                                 ...
                                 <!--begin::Menu item-->
                                 <div class="menu-item px-3">
                                    <a class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_delete{{$department->id}}">Delete</a>
                                 </div>
                                 <!--end::Menu item-->
                              </div>
                           </td>
                           <!--begin::Modal - New Target-->
                           <div class="modal fade" id="kt_modal_delete{{$department->id}}" tabindex="-1" aria-hidden="true">
                              <!--begin::Modal dialog-->
                              <div class="modal-dialog modal-dialog-centered mw-650px">
                                 <!--begin::Modal content-->
                                 <div class="modal-content rounded">
                                    ...
                                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                       <!--begin:Form-->
                                       <form action="{{route('department.destroy',$department->id)}}" method="POST" enctype="multipart/form-data" class="form">
                                          @csrf
                                          <!--begin::Heading-->
                                          <div class="mb-13 text-center">
                                             <h1 class="mb-3">Delete Department</h1>
