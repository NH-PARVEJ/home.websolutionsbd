   ...
   <div id="kt_app_content_container" class="app-container container-xxl">
      <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
         <div class="card">
            <div class="card-body">
               <!--begin:Form-->
               <form action="{{route('admin.leave.update',$leave->id)}}" method="POST" enctype="multipart/form-data" class="form">
                @csrf
                <!--begin::Heading-->
                   ...
                   <div class="fv-row">
                    ...
                    <div class="w-100">
                       ...
                       <select id="kt_ecommerce_select2_country" class="form-select form-select-solid" name="status" data-kt-ecommerce-settings-type="select2_flags">
                          ...
                          <option value="1"@if($leave->status == 1) selected @endif>Panding</option>
                          <option value="2"@if($leave->status == 2) selected @endif>Approved</option>
                          <option value="3"@if($leave->status == 3) selected @endif>Cancelled</option>
                       </select>
                       <!--end::Select2-->
                 </div>
                 <!--end::Input group-->
