   ...
   <div id="kt_app_content_container" class="app-container container-xxl">
      <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
         <div class="card">
            <div class="card-body">
               <!--begin:Form-->
               <form action="{{route('user.loan.update',$loan->id)}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_settings_general_form" class="form">
                  @csrf
                  <!--begin::Heading-->
                  ...
                  <div class="fv-row">
                     ...
                     <div class="w-100">
                        ...
                        <select id="kt_ecommerce_select2_country" class="form-select form-select-solid" name="payment_terms" data-kt-ecommerce-settings-type="select2_flags">
                           <option>Select Payment erms</option>
